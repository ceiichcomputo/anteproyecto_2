...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'anteproyecto'], function () {
            ...
            Route::livewire('detalle_rubro/{anteproyecto_id}/{rubro_id}', 'pages::dashboard.anteproyecto.detalle_rubro')->name('anteproyecto.detalle_rubro');
        });
        Route::group(['prefix' => 'reportes'], function () {
            Route::livewire('anteproyectos', 'pages::dashboard.reportes.anteproyecto')->name('reportes.anteproyecto');
        });
    });

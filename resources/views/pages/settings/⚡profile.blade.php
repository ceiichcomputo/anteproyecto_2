...
new #[Title('Profile settings')] class extends Component {
    ...
    public function resendVerificationNotification(): void
    {
        ...
        Flux::toast(text: __('Se ha enviado un nuevo enlace de verificación a tu dirección de correo electrónico.'));
    }
...
<section class="w-full">
    ...
    <x-pages::settings.layout :heading="__('Cuenta')" :subheading="__('Actualiza tu nombre de usuario y correo electrónico.')">
